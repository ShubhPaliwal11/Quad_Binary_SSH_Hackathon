        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              >
                <span className="block bg-gradient-to-r from-blue-600 to-teal-500 bg-clip-text text-transparent">AarogyaSaarthi</span>
              </h1>
              <p
        ...
        <div className="mb-8">
          <div className="flex gap-5 max-lg:flex-col max-lg:gap-0">
            ...
            <div className="flex flex-col w-1/2 max-lg:w-full">
              ...
              <motion.div
                className="mt-28 grid grid-cols-1 md:grid-cols-2 gap-4"
